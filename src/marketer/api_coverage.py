...
COVERAGE_MANIFEST: dict[RouteKey, Coverage] = {
    ...
    ("POST", "/api/v1/jobs/{job_id}/approve"): Coverage("approve_job", "approve_job"),
    ("POST", "/api/v1/jobs/{job_id}/reject"): Coverage("reject_job", "reject_job"),
    ("GET", "/api/v1/jobs/{job_id}/metrics"): Coverage("job_metrics", "job_metrics"),
    ...
    ("GET", "/api/v1/spend/history"): Coverage("spend_history", "spend_history"),
    ("POST", "/api/v1/connect/ayrshare"): Coverage("connect_ayrshare", "connect_ayrshare"),
    ("GET", "/api/v1/billing/balance"): Coverage("billing_balance", "billing_balance"),
    ("POST", "/api/v1/billing/checkout"): Coverage("billing_checkout", "billing_checkout"),
    ("GET", "/api/v1/campaigns"): Coverage("list_campaigns", "list_campaigns"),
    ("POST", "/api/v1/campaigns"): Coverage("create_campaign", "create_campaign"),
    ("GET", "/api/v1/campaigns/{campaign_id}"): Coverage("get_campaign", "get_campaign"),
    ("POST", "/api/v1/campaigns/{campaign_id}/start"): Coverage(
        "start_campaign", "start_campaign"
    ),
    ("POST", "/api/v1/campaigns/{campaign_id}/pause"): Coverage(
        "pause_campaign", "pause_campaign"
    ),
    ("GET", "/api/v1/library"): Coverage("list_library", "list_library"),
    ("GET", "/api/v1/failures"): Coverage("list_failures", "list_failures"),
    ("POST", "/api/v1/failures/replay/{kind}/{item_id}"): Coverage(
...
PARTIAL_COVERAGE: dict[RouteKey, Coverage] = {
    ...
    ("GET", "/api/v1/billing/packs"): Coverage(sdk_method="billing_packs"),
    ("GET", "/api/v1/providers/video-models"): Coverage(mcp_tool="list_video_models"),
    ("GET", "/api/v1/ugc/models"): Coverage(mcp_tool="list_image_models"),
    ("POST", "/api/v1/ugc/renders"): Coverage(mcp_tool="submit_video_generation"),
    ("GET", "/api/v1/ugc/renders"): Coverage(mcp_tool="list_video_generations"),
    ("GET", "/api/v1/ugc/renders/{render_id}"): Coverage(mcp_tool="get_video_generation"),
    ("POST", "/api/v1/ugc/renders/{render_id}/retry"): Coverage(
        mcp_tool="retry_video_generation"
    ),
}

# Extra MCP tool names that share a route already listed above (asset
# download uses the same render row as get_video_generation).
_MCP_ALIASES = frozenset({"get_generation_asset"})
...
KNOWN_GAPS: dict[RouteKey, str] = {
    ...
    # ---- billing: packs still SDK-only ------------------------------------------
    ("GET", "/api/v1/billing/packs"): "SDK has billing_packs(); MCP tool not registered",
    # ---- metrics ----------------------------------------------------------------
    ("GET", "/api/v1/metrics/summary"): "no SDK/MCP coverage yet",
    # ---- library: list covered; compositions not --------------------------------
    ...
    # ---- campaigns: list/get/create/start/pause covered -------------------------
    ...
    # ---- ported suite surfaces (flagged off at launch) --------------------------
    ("DELETE", "/api/v1/cinema/saved/{saved_id}"): "ported surface — no SDK/MCP coverage yet",
    ("DELETE", "/api/v1/cms/collections/{collection_id}"): "ported surface — no SDK/MCP coverage yet",
    ("DELETE", "/api/v1/headshots/sources/{source_id}"): "ported surface — no SDK/MCP coverage yet",
    ("DELETE", "/api/v1/headshots/{batch_id}"): "ported surface — no SDK/MCP coverage yet",
    ("DELETE", "/api/v1/personas/{persona_id}"): "ported surface — no SDK/MCP coverage yet",
    ("DELETE", "/api/v1/personas/{persona_id}/messages"): "ported surface — no SDK/MCP coverage yet",
    ("DELETE", "/api/v1/scheduled-posts/recurring/{slot_id}"): "ported surface — no SDK/MCP coverage yet",
    ("DELETE", "/api/v1/scheduled-posts/{post_id}"): "ported surface — no SDK/MCP coverage yet",
    ("DELETE", "/api/v1/seo-audits/{audit_id}"): "ported surface — no SDK/MCP coverage yet",
    ("DELETE", "/api/v1/ugc/renders/{render_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/ad-creatives"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/ad-creatives/{run_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/ad-creatives/{run_id}/slots/{slot_id}/image"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/cinema/catalog"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/cinema/presets"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/cinema/saved"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/cms/articles/by-slug/{slug}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/cms/articles/{article_id}/revisions"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/cms/articles/{article_id}/revisions/{revision_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/cms/collections"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/design/projects"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/design/projects/{project_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/design/projects/{project_id}/steps/{step_id}/image"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/dramas"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/dramas/{drama_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/dramas/{drama_id}/characters/{character_id}/image"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/dramas/{drama_id}/video"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/formats"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/formats/trends"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/formats/trends/{report_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/formats/{key}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/gatekeeper/audit"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/gatekeeper/intents"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/gatekeeper/intents/{intent_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/headshots"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/headshots/sources/{source_id}/image"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/headshots/styles"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/headshots/{batch_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/headshots/{batch_id}/variants/{variant_id}/image"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/motion/projects"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/motion/projects/{project_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/motion/projects/{project_id}/video"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/motion/styles"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/personas"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/personas/{persona_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/personas/{persona_id}/messages"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/personas/{persona_id}/visual"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/scheduled-posts"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/scheduled-posts/recurring"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/scheduled-posts/{post_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/seo-audits"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/seo-audits/{audit_id}"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/seo-audits/{audit_id}/prompt"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/ugc/models"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/ugc/renders"): "ported surface — no SDK/MCP coverage yet",
    ("GET", "/api/v1/ugc/renders/{render_id}"): "ported surface — no SDK/MCP coverage yet",
    ("PATCH", "/api/v1/cms/articles/{article_id}"): "ported surface — no SDK/MCP coverage yet",
    ("PATCH", "/api/v1/cms/collections/{collection_id}"): "ported surface — no SDK/MCP coverage yet",
    ("PATCH", "/api/v1/scheduled-posts/{post_id}"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/ad-creatives"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/ad-creatives/{run_id}/slots/{slot_id}/retry"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/cinema/compose"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/cinema/saved"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/cms/articles/{article_id}/publish"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/cms/articles/{article_id}/revisions/{revision_id}/restore"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/cms/articles/{article_id}/unpublish"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/cms/bulk-topics"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/cms/collections"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/cms/collections/{collection_id}/articles"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/design/projects"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/design/projects/{project_id}/retry"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/design/projects/{project_id}/steps/{step_id}/retry"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/dramas"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/dramas/{drama_id}/retry"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/formats/trends"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/gatekeeper/intents/decide"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/gatekeeper/intents/{intent_id}/decide"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/headshots"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/headshots/sources"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/headshots/{batch_id}/retry"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/motion/projects"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/motion/projects/{project_id}/retry"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/personas"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/personas/{persona_id}/messages"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/personas/{persona_id}/visual"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/scheduled-posts"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/scheduled-posts/import"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/scheduled-posts/recurring"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/scheduled-posts/{post_id}/publish-now"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/seo-audits"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/ugc/renders"): "ported surface — no SDK/MCP coverage yet",
    ("POST", "/api/v1/ugc/renders/{render_id}/retry"): "ported surface — no SDK/MCP coverage yet",
    ("PUT", "/api/v1/personas/{persona_id}"): "ported surface — no SDK/MCP coverage yet",
}
