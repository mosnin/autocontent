...
interface ImageBoxProps {
    ...
    style?: CSSProperties;
    /**
     * Accepted but currently unused. Both call sites pass a responsive
     * value from `useTunnelConfig` (5 / 6 / 10 by breakpoint), but the
     * tunnel is dimensioned by `grid`, so the value is discarded. Declared
     * so the delivered call sites typecheck; wiring it to `grid` would
     * change the rendering and is a design decision, not a type fix.
     */
    tunnelSize?: number;
}
