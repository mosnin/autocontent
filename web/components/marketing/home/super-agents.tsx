...
import { Reveal, TextReveal, Parallax, Magnetic } from "@/components/marketing/system";
    ...
    <section aria-label="Agents" className="bg-white py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <Reveal className="mt-16" delay={0.1}>
          <Parallax className="group relative aspect-[21/10] overflow-hidden rounded-[2rem] shadow-[0_24px_80px_rgba(15,23,42,0.10)]" speed={-0.12}>
