        ...
        <div className="mx-auto mt-10 max-w-6xl">
          <AnimatePresence initial={false} mode="wait">
            <motion.div
              ...
              className="grid gap-8 rounded-[2rem] border border-border bg-white p-8 shadow-[0_8px_40px_rgba(15,23,42,0.06)] md:grid-cols-[1.2fr_1fr] md:p-12"
            ...
            >
              <div>
                ...
                <ul className="mt-6 space-y-3">
                  {team.checks.map((c) => (
                    <li className="flex items-start gap-3 text-[15px] text-foreground" key={c}>
                      <Check />
                      {c}
                    </li>
                  ))}
              ...
              <div className="grid content-start gap-4">
                {team.cards.map((card) => (
                  <Link
                    className="group rounded-2xl border border-border bg-[#fafbfc] p-5 transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(15,23,42,0.08)]"
                    href={card.href}
                    key={card.title}
                  >
                    ...
                    <span className="mt-3 inline-flex items-center gap-1 text-[13px] font-medium text-foreground group-hover:text-foreground">
                      Learn more
                      <svg
                        aria-hidden
