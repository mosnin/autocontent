...
API_DESCRIPTION = (
    "Programmatic access to marketer: campaigns, articles, billing, "
...
TAG_GROUPS: dict[str, list[str]] = {
    "Content": [
        "articles", "templates", "style-presets", "library", "brand-kit", "kits",
        "ugc", "dramas", "cinema", "motion", "cms",
    ],
    "Campaigns & Ads": [
        "campaigns", "ads", "ad-creatives", "calendar", "image-posts",
        "niches", "performance", "scheduled-posts",
    ],
    "Billing & Spend": ["billing", "spend", "x402"],
    "Platform": [
        "users", "tokens", "connect", "providers", "voices",
        "personas", "headshots", "design", "formats", "seo-audits",
    ],
    "Operations": [
        "jobs", "ops", "failures", "metrics", "admin", "webhooks",
        "webhooks-out", "gatekeeper",
    ],
    "System": ["health"],
}
