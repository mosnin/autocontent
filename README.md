...
- **HTTP bounds** — 40/min Jev judges, 20/min ads (judge + connect/budget/status/decide) + article social, 10/min enqueue/retry/approve/replay/remix, 8/min voice + niche draft. Every `/jev` POST meters spend fail-open.
