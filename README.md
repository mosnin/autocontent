...
- **Template ideation / article fastpaths** — Jev picks among code-built ideas, outlines, titles, FAQs, checklists, definitions, how-tos, mistakes, in-practice H2s, social snippets, and onboarding niche drafts. The writer only writes prose. Dark-path article and video QA are heuristics; dark-path ideation, carousels, default video scripts, and niche drafts use templates, not a writer. An operator-pinned script model or a narrative brief still buys the scriptwriter LLM.
